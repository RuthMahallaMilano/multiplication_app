...
# TODO 1. התרגילים והפתרונות לא מסונכרנים 2. איך להוסיף את הנתונים לטבלה המקשרת 3. ליצור עוד כדף בית שמופיעים בו כל היוזרים והתוצאות שלהם?
...
def home():
    ...
    elif session["current_question"] not in exercises_dict:   #TODO not sure it works
   ...
   # solved = "1111" # Exercise.query.join(Exercise.users).filter(User.name == 'bob')
